...
/* TOUCHKEYS bank(s) definition*/
   ...
   {&MyChannels_Src[5], &MyChannels_Dest[5], MyChannels_Data, BANK_3_NBCHANNELS, BANK_3_MSK_CHANNELS, BANK_3_MSK_GROUPS},
   {&MyChannels_Src[7], &MyChannels_Dest[7], MyChannels_Data, BANK_4_NBCHANNELS, BANK_4_MSK_CHANNELS, BANK_4_MSK_GROUPS},
   {&MyChannels_Src[8], &MyChannels_Dest[8], MyChannels_Data, BANK_5_NBCHANNELS, BANK_5_MSK_CHANNELS, BANK_5_MSK_GROUPS},
};
/*============================================================================*/
/* Touchkey sensors                                                           */
/*============================================================================*/
