...
#define CHANNEL_5_IO_MSK    (TSC_GROUP1_IO3)
...
#define CHANNEL_7_IO_MSK    (TSC_GROUP3_IO4)
#define CHANNEL_7_GRP_MSK   (TSC_GROUP3)
#define CHANNEL_7_SRC       (TSC_GROUP3_IDX)
#define CHANNEL_7_DEST      (7)

#define CHANNEL_8_IO_MSK    (TSC_GROUP4_IO3)
#define CHANNEL_8_GRP_MSK   (TSC_GROUP4)
#define CHANNEL_8_SRC       (TSC_GROUP4_IDX)
#define CHANNEL_8_DEST      (8)

#define CHANNEL_9_IO_MSK    (TSC_GROUP5_IO3)
#define CHANNEL_9_GRP_MSK   (TSC_GROUP5)
#define CHANNEL_9_SRC       (TSC_GROUP5_IDX)
#define CHANNEL_9_DEST      (9)

#define CHANNEL_10_IO_MSK    (TSC_GROUP1_IO4)
#define CHANNEL_10_GRP_MSK   (TSC_GROUP1)
#define CHANNEL_10_SRC       (TSC_GROUP1_IDX)
#define CHANNEL_10_DEST      (10)

#define CHANNEL_11_IO_MSK    (TSC_GROUP2_IO4)
#define CHANNEL_11_GRP_MSK   (TSC_GROUP2)
#define CHANNEL_11_SRC       (TSC_GROUP2_IDX)
#define CHANNEL_11_DEST      (11)

#define CHANNEL_12_IO_MSK    (TSC_GROUP4_IO4)
#define CHANNEL_12_GRP_MSK   (TSC_GROUP4)
#define CHANNEL_12_SRC       (TSC_GROUP4_IDX)
#define CHANNEL_12_DEST      (12)

#define CHANNEL_13_IO_MSK    (TSC_GROUP5_IO4)
#define CHANNEL_13_GRP_MSK   (TSC_GROUP5)
#define CHANNEL_13_SRC       (TSC_GROUP5_IDX)
...
#define BANK_2_MSK_CHANNELS   (CHANNEL_10_IO_MSK | CHANNEL_11_IO_MSK | CHANNEL_12_IO_MSK | CHANNEL_13_IO_MSK)
#define BANK_2_MSK_GROUPS     (CHANNEL_10_GRP_MSK | CHANNEL_11_GRP_MSK | CHANNEL_12_GRP_MSK | CHANNEL_13_GRP_MSK)
