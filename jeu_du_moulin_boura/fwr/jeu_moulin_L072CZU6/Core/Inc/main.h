...
#define CS_G3_Pin GPIO_PIN_0
#define CS_G3_GPIO_Port GPIOB
...
#define CS_G4_Pin GPIO_PIN_9
#define CS_G4_GPIO_Port GPIOA
...
#define L3_LED_Pin GPIO_PIN_15
#define L3_LED_GPIO_Port GPIOA
#define C3_LED_Pin GPIO_PIN_3
#define C3_LED_GPIO_Port GPIOB
#define L2_LED_Pin GPIO_PIN_4
#define L2_LED_GPIO_Port GPIOB
#define C2_LED_Pin GPIO_PIN_5
#define C2_LED_GPIO_Port GPIOB
#define L1_LED_Pin GPIO_PIN_6
