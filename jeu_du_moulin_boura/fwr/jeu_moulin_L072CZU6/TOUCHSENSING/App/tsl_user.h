...
#define BANK_1_MSK_CHANNELS   (CHANNEL_4_IO_MSK | CHANNEL_5_IO_MSK | CHANNEL_6_IO_MSK | CHANNEL_7_IO_MSK)
#define BANK_1_MSK_GROUPS     (CHANNEL_4_GRP_MSK | CHANNEL_5_GRP_MSK | CHANNEL_6_GRP_MSK | CHANNEL_7_GRP_MSK)

#define BANK_2_NBCHANNELS (3)
#define BANK_2_MSK_CHANNELS   (CHANNEL_8_IO_MSK | CHANNEL_9_IO_MSK | CHANNEL_10_IO_MSK)
#define BANK_2_MSK_GROUPS     (CHANNEL_8_GRP_MSK | CHANNEL_9_GRP_MSK | CHANNEL_10_GRP_MSK)
